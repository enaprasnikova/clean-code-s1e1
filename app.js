...
var createNewTaskElement = function (taskString) {
  ...
  label.className = 'text-task task__label';

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.className = 'task__checkbox';
  editInput.type = "text";
  editInput.className = "text-task task__input-text";
...
var editTask = function () {
  ...
  if (containsClass) {
    ...
    label.classList.remove('task__label_none');
    editInput.classList.remove('task__input-text_block');
  } else {
    editInput.value = label.innerText;
    editBtn.innerText = "Save";
    label.classList.add('task__label_none');
    editInput.classList.add('task__input-text_block');
  }
